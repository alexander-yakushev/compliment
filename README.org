...
** Rationale
   ...
   - *Editor agnosticism.* /Your freedom is valuable, and you should/
     /be able to choose any coding tools you want./ This is achieved
     by having the dumbest client possible (but to the point where
     speed is not impaired). Ideally editor should not know about
     completion at all, only giving the prefix to Compliment and
     showing the results.
